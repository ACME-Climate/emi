...
contains
  ...
  !------------------------------------------------------------------------
  subroutine EM_VSFM_SPAC_Init(this, l2e_init_list, e2l_init_list, iam)
...
#include "finclude/petscdmda.h90"
  ...
  subroutine extract_data_for_alm(this, l2e_init_list, e2l_init_list)
    ...
    num = vsfm_mpp%sysofeqns%num_auxvars_in
  ...
  subroutine EM_VSFM_SPAC_Solve(this, em_stage, dt, nstep, clump_rank, l2e_list, e2l_list)
    ...
    case (EM_VSFM_SOIL_HYDRO_STAGE)
       call EM_VSFM_SPAC_Solve_Soil_Hydro(this, em_stage, dt, nstep, l2e_list, e2l_list)
    case default
  ...
  !------------------------------------------------------------------------
  subroutine EM_VSFM_SPAC_Solve_Soil_Hydro(this, em_stage, dt, nstep, l2e_list, e2l_list)
    !
    ! !DESCRIPTION:
